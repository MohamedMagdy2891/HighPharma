                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-tools" style="font-size: 1.3rem"> اضافة بيانات العميل</h3>
                            ...
                            <!-- form start -->
                            <form role="form" method="POST" action="<?php echo e(route('admin.clients.store')); ?>">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Mohamed\programes\Newfolder\Newfolder\HighPharma\resources\views/admin/clients/create.blade.php ENDPATH**/ ?>