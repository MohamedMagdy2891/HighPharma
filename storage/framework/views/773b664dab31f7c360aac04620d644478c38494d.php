                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-tools" style="font-size: 1.3rem"> تعديل بيانات منتج :
                            ...
                            <!-- form start -->
                            <form role="form" method="POST" action="<?php echo e(route('admin.products.update', $row->id)); ?>">
                                <?php echo csrf_field(); ?>
    ...
    <?php if(Session::has('failed')): ?>
        <script>
            $(function() {
                ...
                Toast.fire({
                    type: 'error',
                    title: '<?php echo e(Session::get('failed')); ?>'
                });
            });
        </script>
    <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Mohamed\programes\Newfolder\Newfolder\HighPharma\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>